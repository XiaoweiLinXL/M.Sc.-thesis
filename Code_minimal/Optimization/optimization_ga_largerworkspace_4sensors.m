...
save('results_4_3_axis_multiobj_1000gen_1000pop_workspace048_distance10_finer_smaller_sphere_bigger_workspace_median_sigma_min')
...
grid on
xlabel('$min_{x\in \mathcal{X}} \frac{1}{\kappa}(x)$', 'Interpreter', 'latex')
