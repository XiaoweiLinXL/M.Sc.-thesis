...
save('results_3_3_axis_multiobj_1000gen_1000pop_workspace048_distance10_finer_smaller_sphere_bigger_workspace_mean_sigma_min')
...
function obj = min_fun_orientation(sens_conf, magnet_conf, B_r, Volumn, type)
    ...
    obj = [-min(reciprocal_condition_number_set), -mean(min_svd_set)];
end
