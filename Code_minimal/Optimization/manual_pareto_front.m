...
figure
scatter(rcond_all_sens_conf_circle, mean_min_svd_all_sens_conf_circle)
% hold on
...
figure
hold on
plot(radius, rcond_all_sens_conf_circle, LineWidth=2)
plot(radius, average_rcond_all_sens_conf_circle, LineWidth=2)
...
figure
hold on
plot_points_with_arrows(rcond_all_sens_conf_circle, mean_min_svd_all_sens_conf_circle, [0.8500, 0.3250, 0.0980])
hold on
...
%% Chi distribution
number_of_sensor_range = 20:1:20;
...
percential998_noise = [3.2530e-7, 3.5860e-7, 3.8780e-7, 4.1410e-7, 4.3830e-7, 4.6090e-7, 4.8200e-7, 5.0200e-7, 5.2090e-7, 5.3910e-7, ...
                   5.5650e-7, 5.7320e-7, 5.8930e-7, 6.0490e-7, 6.2010e-7, 6.3470e-7, 6.4900e-7, 6.6290e-7];

signal_to_noise_ratio = min_sigma_min./percential998_noise;


figure
hold on
plot(sensor_number, min_sigma_min, LineWidth=2);
plot(sensor_number, percential998_noise, LineWidth=2);
xlabel("Sensor number", 'Interpreter', 'latex');
