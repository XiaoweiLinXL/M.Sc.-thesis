...
ub = [0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      ...
      0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGeneration', 2000, 'PopulationSize', 35000);
...
save('results_5_one_axis_decimeter_max_rcond_9_2000gen_35000pop')
%%
% Evaluate
load('results_5_one_axis_decimeter_max_rcond_9_2000gen_35000pop.mat')
sens_conf = [sol];
