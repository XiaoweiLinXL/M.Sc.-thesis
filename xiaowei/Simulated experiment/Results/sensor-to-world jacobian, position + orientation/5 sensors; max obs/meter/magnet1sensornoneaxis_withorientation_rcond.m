...
%% Genetic algorithm
lb = [-5/scale -5/scale 0.0 -1 -1 -1 -1 ...
      -5/scale -5/scale 0.0 -1 -1 -1 -1 ...
      -5/scale -5/scale 0.0 -1 -1 -1 -1 ...
      -5/scale -5/scale 0.0 -1 -1 -1 -1 ...
      -5/scale -5/scale 0.0 -1 -1 -1 -1 ...
      5];
ub = [5/scale 5/scale 0.0 1 1 1 1 ...
      5/scale 5/scale 0.0 1 1 1 1 ...
      5/scale 5/scale 0.0 1 1 1 1 ...
      5/scale 5/scale 0.0 1 1 1 1 ...
      5/scale 5/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 5000, 'MaxGenerations', 5000, 'PopulationSize', 10000);
...
save('results_5_three_axis_workspace5')
%%
% Evaluate
load('results_5_three_axis.mat')
sens_conf = [sol];
magnet_conf = [0;0;0.2;0;deg2rad(89)];
