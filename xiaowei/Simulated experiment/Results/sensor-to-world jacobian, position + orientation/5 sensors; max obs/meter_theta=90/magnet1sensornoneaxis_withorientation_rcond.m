...
ub = [0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      ...
      0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 3000, 'MaxGenerations', 3000, 'PopulationSize', 20000);
...
save('results_5_one_axis_meter_max_rcond_3000gen_20000pop_2')
%%
% Evaluate
load('results_5_one_axis_meter_max_rcond_3000gen_20000pop_2.mat')
sens_conf = [sol];
magnet_conf = [0;0;0.2;deg2rad(90);0]
