...
%% Genetic algorithm
lb = [-0.4/scale -0.4/scale 0.0 -1 -1 -1 -1 ...
      -0.4/scale -0.4/scale 0.0 -1 -1 -1 -1 ...
      -0.4/scale -0.4/scale 0.0 -1 -1 -1 -1 ...
      -0.4/scale -0.4/scale 0.0 -1 -1 -1 -1 ...
      -0.4/scale -0.4/scale 0.0 -1 -1 -1 -1 ...
      5];
ub = [0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 20000, 'MaxGenerations', 20000, 'PopulationSize', 20000);
...
save('results_5_one_axis_decimeter_max_rcond_20000gen_20000pop_04workspace')
%%
% Evaluate
load('results_5_one_axis_decimeter_max_rcond_10000gen_10000pop_04workspace.mat')
sens_conf = [sol];
