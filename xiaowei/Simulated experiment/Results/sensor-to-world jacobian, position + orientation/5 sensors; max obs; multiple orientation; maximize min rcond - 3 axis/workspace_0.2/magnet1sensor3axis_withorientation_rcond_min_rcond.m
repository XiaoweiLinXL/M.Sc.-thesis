...
save('results_5_3_axis_meter_max_rcond_min_rcond_2000gen_20000pop')
%%
% Evaluate
load('results_5_3_axis_meter_max_rcond_min_rcond_2000gen_20000pop.mat')
sens_conf = [sol];
% magnet_conf = [0;0;0.2;deg2rad(-135);deg2rad(-45)]
