...
save('results_5_one_axis_meter_max_rcond_multiobj_2000gen_20000pop_halfball')
%%
% Evaluate
load('results_5_one_axis_meter_max_rcond_multiobj_2000gen_20000pop_halfball.mat')
sens_conf = [sol(5461,:)];
