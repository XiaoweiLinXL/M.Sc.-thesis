...
ub = [0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      ...
      0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGeneration', 400, 'PopulationSize', 20000);
...
save('results_5_one_axis_meter_max_rcond_min_rcond_400gen_20000pop')
%%
% Evaluate
load('results_5_one_axis_meter_max_rcond_min_rcond_300gen_20000pop.mat')
sens_conf = [sol];
magnet_conf = [0;0;0.2;deg2rad(360);deg2rad(80)]
