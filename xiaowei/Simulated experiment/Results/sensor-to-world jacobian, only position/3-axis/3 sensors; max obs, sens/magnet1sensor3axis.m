...
magnet_conf = conf;
%% Genetic algorithm
lb = [-0.2 -0.2 -0.05 -1 -1 -1 -1 ...
      -0.2 -0.2 -0.05 -1 -1 -1 -1 ...
      -0.2 -0.2 -0.05 -1 -1 -1 -1 ...
      -0.2 -0.2 -0.05 -1 -1 -1 -1 ...
      -0.2 -0.2 -0.05 -1 -1 -1 -1 ...
      -0.2 -0.2 -0.05 -1 -1 -1 -1 ...
...
function obj = min_fun(sens_conf, magnet_conf, mu, type)
    ...
    for magnet_num=1:size(magnet_conf,2)
        ...
        % Put the min sensor reading of all sensors in to the list
        min_magnetic_field_set = [min_magnetic_field_set; min(sensor_outputs)]; 
    end
