...
angles = linspace(0, 2*pi, 9+1);
angles(end) = [];
x = 0.12 * cos(angles);
y = 0.12 * sin(angles);
initial_guess = [x; y];
initial_guess = reshape(initial_guess, [], 1);
initial_guess = [initial_guess.', 9];
...
save('results_9_3_axis_multiobj_1000gen_1000pop_workspace048_distance10_finer_smaller_sphere_bigger_workspace_median_sigma_min')

%% Plot pareto front
load('results_9_3_axis_multiobj_1000gen_1000pop_workspace048_distance10_finer_smaller_sphere.mat')
figure
