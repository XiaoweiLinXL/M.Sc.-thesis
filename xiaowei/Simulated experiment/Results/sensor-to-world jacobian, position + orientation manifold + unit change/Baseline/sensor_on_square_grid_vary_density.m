...
min_singular_value_J_all_sensor_config_1 = min_singular_value_J_all_sensor_config;
mean_singular_value_J_all_sensor_config_1 = mean_singular_value_J_all_sensor_config;
mean_min_singular_value_J_all_sensor_config_1 = mean_min_singular_value_J_all_sensor_config;
median_min_singular_value_J_all_sensor_config_1 = median_min_singular_value_J_all_sensor_config;
...
figure(2)
plot(number_of_sensor, median_min_singular_value_J_all_sensor_config_1, '-', 'Color', [0, 0.4470, 0.7410], "linewidth", 2)
hold on
plot(number_of_sensor_peri, median_min_singular_value_J_all_sensor_config_2, '-', 'Color', [0.8500, 0.3250, 0.0980], "linewidth", 2)
hold on
