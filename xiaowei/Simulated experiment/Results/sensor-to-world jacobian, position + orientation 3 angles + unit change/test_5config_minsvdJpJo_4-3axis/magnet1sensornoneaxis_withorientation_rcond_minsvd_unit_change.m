...
xlabel('minimum singular value Jp')
ylabel('minimum singular value Jo')
title('Minimum singular value of Jp and Jo')
%%
figure
...
ylabel('minimum singular value Jo')
zlabel('rcond')
title('Rcond vs minimum singular value of Jp and Jo')
%% Jacobian test
