...
ub = [0.2 0.2 0.0 1 1 1 1 ...
      ...
      0.2 0.2 0.0 1 1 1 1 ...
      4];
options = optimoptions(@gamultiobj,'Display','iter','MaxStallGenerations',5000, "PopulationSize",1000);

fun = @(x) min_fun(x, magnet_conf, mu, type);
[sol, fval, exitflag, output] = gamultiobj(fun, length(lb), [], [], [], [], lb, ub, [], length(lb), options);

save('results_three_axis_5000gen_1000pop')
%% Evaluate
load('results_three_axis_5000gen_1000pop.mat')
sens_conf = [sol];
