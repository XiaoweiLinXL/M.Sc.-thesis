...
%% Genetic algorithm
lb = [-0.24/scale -0.24/scale ...
      -0.24/scale -0.24/scale ...
      -0.24/scale -0.24/scale ...
      -0.24/scale -0.24/scale ...
      4];
ub = [0.24/scale 0.24/scale ...
      0.24/scale 0.24/scale ...
      0.24/scale 0.24/scale ...
      0.24/scale 0.24/scale ...
      4];

initial_guess = [-0.12,-0.12,-0.12,0.12,0.12,-0.12,0.12,0.12,4;
                 ];
...
save('results_4_3_axis_multiobj_1000gen_1000pop_workspace048_distance10_finer_smaller_sphere')

%% Plot pareto front
load('results_4_3_axis_multiobj_1000gen_1000pop_workspace048_distance10.mat')
figure
...
%% jacobian test
scale = 1;
sens_conf = [-0.06/scale -0.32/scale ...
      -0.27/scale 0.12/scale ...
      0.36/scale -0.62/scale ...
      0.73/scale 0.24/scale ...
      4];
