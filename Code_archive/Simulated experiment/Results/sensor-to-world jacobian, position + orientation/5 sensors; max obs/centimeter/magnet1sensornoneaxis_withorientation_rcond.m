...
ub = [0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      ...
      0.2/scale 0.2/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 25000, 'MaxGenerations', 25000, 'PopulationSize', 25000);
...
save('results_5_one_axis_centimeter_max_rcond_5_25000gen_25000pop')
%%
% Evaluate
