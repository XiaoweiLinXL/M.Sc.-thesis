...
ub = [0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      ...
      0.4/scale 0.4/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 10000, 'MaxGenerations', 10000, 'PopulationSize', 5000);
...
save('results_5_one_axis_decimeter_max_min_svd_10000gen_5000pop_04workspace')
%%
% Evaluate
load('results_5_one_axis_decimeter_max_rcond_10000gen_5000pop_04workspace.mat')
sens_conf = [sol];
