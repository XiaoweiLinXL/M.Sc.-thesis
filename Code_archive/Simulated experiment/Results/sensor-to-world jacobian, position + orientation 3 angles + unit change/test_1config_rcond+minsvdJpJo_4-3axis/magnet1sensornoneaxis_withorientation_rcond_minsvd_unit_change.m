...
%%
scatter3(obj_svd_Jp, obj_svd_Jo, obj_rcond)
xlabel('min singular value Jp')
ylabel('min singular value Jo')
zlabel('rcond')
...
xlabel('rcond')
ylabel('minimum singular value of J')
title('Result for rcond and minimum singular value of J')
%% Jacobian test
