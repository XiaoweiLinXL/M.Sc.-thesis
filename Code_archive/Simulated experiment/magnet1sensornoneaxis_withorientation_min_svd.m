...
%% Genetic algorithm
lb = [-4/scale -4/scale 0.0 -1 -1 -1 -1 ...
      -4/scale -4/scale 0.0 -1 -1 -1 -1 ...
      -4/scale -4/scale 0.0 -1 -1 -1 -1 ...
      -4/scale -4/scale 0.0 -1 -1 -1 -1 ...
      -4/scale -4/scale 0.0 -1 -1 -1 -1 ...
      5];
ub = [4/scale 4/scale 0.0 1 1 1 1 ...
      4/scale 4/scale 0.0 1 1 1 1 ...
      4/scale 4/scale 0.0 1 1 1 1 ...
      4/scale 4/scale 0.0 1 1 1 1 ...
      4/scale 4/scale 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 5000, 'MaxGenerations', 5000, 'PopulationSize', 5000);
...
save('results_5_one_axis_meter_min_svd_4workspace')
%%
% Evaluate
load('results_5_one_axis_meter_min_svd_4workspace.mat')
sens_conf = [sol];
