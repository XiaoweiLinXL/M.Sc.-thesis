...
ub = [0.2 0.2 0.0 1 0 0 0 ...
      ...
      0.2 0.2 0.0 1 0 0 0 ...
      3];
options = optimoptions(@gamultiobj,'Display','iter','MaxStallGenerations',1000,'PopulationSize',500);

fun = @(x) min_fun(x, magnet_conf, mu, type);
[sol, fval, exitflag, output] = gamultiobj(fun, length(lb), [], [], [], [], lb, ub, [], length(lb), options);

save('results_one_axis')
...
%% Genetic algorithm sensor number fixed
lb = [-0.2 -0.2 0.0 -inf -inf -inf -inf ...
      -0.2 -0.2 0.0 -inf -inf -inf -inf ...
      -0.2 -0.2 0.0 -inf -inf -inf -inf ...
      -0.2 -0.2 0.0 -inf -inf -inf -inf ...
      -0.2 -0.2 0.0 -inf -inf -inf -inf ...
      -0.2 -0.2 0.0 -inf -inf -inf -inf ...
...
ub = [0.2 0.2 0.0 inf inf inf inf ...
      0.2 0.2 0.0 inf inf inf inf ...
      0.2 0.2 0.0 inf inf inf inf ...
      0.2 0.2 0.0 inf inf inf inf ...
      0.2 0.2 0.0 inf inf inf inf ...
...
sens_num = 3;
options = optimoptions(@gamultiobj,'Display','iter','MaxStallGenerations',2000);

fun = @(x) min_fun_sensor_num_fixed(x, magnet_conf, mu, type, sens_num);
[sol, fval, exitflag, output] = gamultiobj(fun, length(lb), [], [], [], [], lb, ub, @quaternion_constraint, [], options);

save('results_one_axis_fixed_sensor_num')
...
%% Objective with nonlinear equality constraint, sensor number fixed
function obj = min_fun_sensor_num_fixed(sens_conf, magnet_conf, mu, type, sens_num)
...
function [c,ceq] = quaternion_constraint(x)
    c=[];
    ceq(1) = x(4)^2 + x(5)^2 + x(6)^2 + x(7)^2 - 1;
    ceq(2) = x(11)^2 + x(12)^2 + x(13)^2 + x(14)^2 - 1;
    ceq(3) = x(18)^2 + x(19)^2 + x(20)^2 + x(21)^2 - 1;
    ceq(4) = x(25)^2 + x(26)^2 + x(27)^2 + x(28)^2 - 1;
    ceq(5) = x(32)^2 + x(33)^2 + x(34)^2 + x(35)^2 - 1;
    ceq(6) = x(39)^2 + x(40)^2 + x(41)^2 + x(42)^2 - 1;
    ceq(7) = x(46)^2 + x(47)^2 + x(48)^2 + x(49)^2 - 1;
    ceq(8) = x(53)^2 + x(54)^2 + x(55)^2 + x(56)^2 - 1;
    ceq(9) = x(60)^2 + x(61)^2 + x(62)^2 + x(63)^2 - 1;
    ceq(10) = x(67)^2 + x(68)^2 + x(69)^2 + x(70)^2 - 1;
end
