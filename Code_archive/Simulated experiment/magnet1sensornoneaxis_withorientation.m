...
ub = [0.2 0.2 0.0 1 1 1 1 ...
      ...
      0.2 0.2 0.0 1 1 1 1 ...
      5];
options = optimoptions(@gamultiobj,'Display','iter', 'MaxStallGenerations', 50000, 'MaxGenerations', 50000, 'PopulationSize', 5000);
...
save('results_5_one_axis_decimeter_max_rcond_2')
%%
% Evaluate
load('results_5_one_axis_decimeter_max_rcond_1.mat')
sens_conf = [sol];
...
function J = jacobian_analytical_sensor_reading_to_magnet_conf_euler_angle(sens_pos, sens_or, magnet_pos, mu_norm, theta, phi, type) % sens_pos, sens_or, magnet_pos, mu are all in world frame
    ...
    J = [1e-4*J_position, 1e-3*J_angle];
